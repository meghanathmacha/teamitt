function showinvestor(comp)
{
var company=comp.replace(".","");
var company=company.replace(" ","");
var company=company.replace("(","");
var company=company.replace(")","");
if(company.length > 10)
var company=company.substring(0,10);
var txt=$("#invest"+company).html();
if(txt.length==0)
{

url="includes/showinvestor.php?company="+comp;
$.post(url,
function (data) {
			
                                        $('#invest'+company).append("<table>");
					if(data[0].type=="4")
					{
                                        $('#invest'+company).append("<tr><td>No Investor </td></tr>");
					}
					else
					{
                                	...
                                	else if(data[i].type=="3")
					{
						type="Person";
                                        ...
                                        $('#invest'+company).append("<tr><td><strong>"+type+" : </strong></td><td>"+data[i].investor+"</td></tr>");
					}
					}
                                                                                    },'json');
                                        $('#invest'+company).append("</table>");
...
{
var comp=company.replace(".","");
var comp=comp.replace(" ","");
var comp=comp.replace("(","");
var comp=comp.replace(")","");
if(comp.length > 10)
var comp=comp.substring(0,10);
var txt=$("#univ"+comp).html();
if(txt.length==0)
{
...
function (data) {
                                        ...
                                        if(data.university=="")
                                        {
                                        $('#univ'+comp).html("<table><tr><td><strong>Founder :</strong> </td><td>"+data.founder+"</td></tr><tr><td><strong>University:</strong></td><td>NOT GIVEN</td></tr></table>");
                                        }
					else
					{
					var university=data.university;
					university=university.replace(" ","");
                                        $('#univ'+comp).html("<table><tr><td><strong>Founder :</strong> </td><td>"+data.founder+"</td></tr><tr><td><strong>University:</strong></td><td><a style='color:#3B3131;text-decoration:underline;' href='university.php?university="+university+"'>"+data.university+"</a></td></tr></table>");
					}
                                                                                    },'json');
$('#univ'+comp).show();
$('#rat'+comp).hide();
