<div class='postArea'>
<div class="postTitle"><span id="action" class="selected">Action</span><span id="thank">Thanks</span><span id="update">Updates</span></div>
<div id="post_recv">
...
<td>
<div class="inputs">
<textarea rows='4' cols='10' id="postEditor" placeholder="Post Actions for yourself or for your connections">
</textarea>
